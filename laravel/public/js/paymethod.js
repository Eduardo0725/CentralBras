...
function pattern(query, reSet) {
  var reClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  var uppercase = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var maxLenght = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : -1;

  document.querySelector(query).onkeypress = function (e) {
    var key = e.key;
    if (key.search(new RegExp(reSet, reClass)) == -1) return false;
  };
}
...
document.querySelector('.paymethod1 div input[name=dateOfBirth]').addEventListener('change', function (e) {
  var doc = document.querySelector('.paymethod1 div input[name=dateOfBirth]');
  if (doc.getAttribute('empty')) doc.setAttribute('empty', 'false');
});
...
/***/ 5:
/*!*****************************************!*\
  !*** multi ./resources/js/paymethod.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\Eduardo\www\centralbras\laravel\resources\js\paymethod.js */"./resources/js/paymethod.js");
